...
if (true) return (Object[])(_list1.Get(_v7));
...
if (anywheresoftware.b4a.keywords.Common.File.Exists(anywheresoftware.b4a.keywords.Common.File.getDirInternal(),_vv1)) { 
 //BA.debugLineNum = 17;BA.debugLine="settings = File.ReadMap(File.DirInternal, setti";
_vv2 = anywheresoftware.b4a.keywords.Common.File.ReadMap(anywheresoftware.b4a.keywords.Common.File.getDirInternal(),_vv1);
 }else {
...
_v = BA.ObjectToString(_vv2.GetDefault((Object)(_key.toLowerCase()),(Object)(_defaultvalue)));
...
_raf.Initialize(anywheresoftware.b4a.keywords.Common.File.getDirInternal(),_v0,anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 243;BA.debugLine="states = raf.ReadObject(0)";
_v6.setObject((anywheresoftware.b4a.objects.collections.Map.MyMap)(_raf.ReadObject((long) (0))));
...
public static boolean  _vv6(anywheresoftware.b4a.BA _ba,anywheresoftware.b4a.objects.ActivityWrapper _activity,String _activityname,int _validperiodinminutes) throws Exception{
...
_list1.setObject((java.util.List)(_v6.Get((Object)(_activityname.toLowerCase()))));
...
anywheresoftware.b4a.keywords.Common.File.WriteMap(anywheresoftware.b4a.keywords.Common.File.getDirInternal(),_vv1,_vv2);
 };
 //BA.debugLineNum = 49;BA.debugLine="End Sub";
return "";
}
public static String  _vv0(anywheresoftware.b4a.BA _ba,anywheresoftware.b4a.objects.ActivityWrapper _activity,String _activityname) throws Exception{
anywheresoftware.b4a.objects.collections.List _list1 = null;
int _i = 0;
...
public static String  _vvv1(anywheresoftware.b4a.BA _ba,String _key,String _value) throws Exception{
...
_vv2.Put((Object)(_key.toLowerCase()),(Object)(_value));
...
_raf.WriteObject((Object)(_v6.getObject()),anywheresoftware.b4a.keywords.Common.True,_raf.CurrentPosition);
