...
_response.GetAsynchronously(processBA,"response",(java.io.OutputStream)(anywheresoftware.b4a.keywords.Common.File.OpenOutput(_vvv1,BA.NumberToString(_taskid),anywheresoftware.b4a.keywords.Common.False).getObject()),anywheresoftware.b4a.keywords.Common.True,_taskid);
...
_vvv1 = anywheresoftware.b4a.keywords.Common.File.getDirInternalCache();
...
_vvvvvvvv6.ExecuteCredentials(processBA,_job._vvvv3(),_vvvvvvvv7,_job._vvvvv7,_job._vvvvv0);
 }else {
 //BA.debugLineNum = 42;BA.debugLine="hc.Execute(job.GetRequest, taskCounter)";
_vvvvvvvv6.Execute(processBA,_job._vvvv3(),_vvvvvvvv7);
 };
